...
#
# Author  : Gaston Gonzalez Purpose : Audio settings specific to the Xiegu X6100
#
# Author  : Gaston Gonzalez
#
...
#
# Author  : Gaston Gonzalez Unmute Speaker and set the volume to 27. Adjust if the remote station
#
